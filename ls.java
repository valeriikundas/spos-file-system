...
public class ls {
     ...
     *
     * @throws java.lang.Exception if an exception is thrown by an underlying
     *                             operation
     */
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("inode number - size - name - uid - gid - mode");
    ...
    private static void print(String name, Stat stat) {
        ...
        // append mode
        s.append(Integer.toOctalString(stat.getMode()));
